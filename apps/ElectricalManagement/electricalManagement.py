...
class ElectricityPrice:
    ...
    def findpeakhours(self,
        ...
        return peak_times, highest_continuous_hours, turn_on_at
    ...
    def remove_hours_from_peak_hours(self,
        ...
        while (
            ...
            if self.elpricestoday[initial_hour] + start_pricedrop > self.elpricestoday[end_hour] + pricedrop:
...
class ElectricalUsage(ad.ADBase):
                        ...
                        for c in self.cars:
                            if (
                                ...
                                if (
                                    ...
                                    # FIXME Check if car should be in queue.
                                    # Need to get a new state after starting to charge?
                                    if (
                                        c.connectedCharger == c.onboardCharger
                                        and ChargingState == 'NoPower'
                                    ):
    ...
    def calculateIdleConsumption(self, kwargs) -> None:
        ...
        for watt in range(len(available_Wh_toCharge)):
            ...
            reducewatt -= float(ElectricityData['consumption']['idleConsumption']['ConsumptionData'][out_temp_str]['Consumption'])
            reducewatt -= float(ElectricityData['consumption']['idleConsumption']['ConsumptionData'][out_temp_str]['HeaterConsumption'])
...
class Car:
    ...
    def findNewChargeTime(self) -> None:
        ...
        if (
            ...
            and self.getCarChargerState != 'NoPower'
        ):
                ...
                try:
                    ...
                    if (
                        ...
                        self.ADapi.log(
                            ...
                            f"No historical data. Wakening car",
                            level = 'DEBUG'
                        )
    ...
    def startCharging(self) -> None:
        ...
        if (
            ...
            or self.getCarChargerState() == 'awaiting_start'
        ):
...
class Heater:
    ...
    def heater_getNewPrices(self, kwargs) -> None:
        ...
        """
        global ELECTRICITYPRICE
        self.time_to_save, self.off_for_hours, self.turn_back_on = ELECTRICITYPRICE.findpeakhours(
...
class Climate(Heater):
    ...
    def heater_setNewValues(self, kwargs) -> None:
        ...
        try:
            min_temp = self.ADapi.get_state(self.heater,
                namespace = self.namespace,
                attribute = 'min_temp'
            )
        except (ValueError, TypeError) as ve:
        ...
        if new_temperature < min_temp:
            new_temperature = min_temp
